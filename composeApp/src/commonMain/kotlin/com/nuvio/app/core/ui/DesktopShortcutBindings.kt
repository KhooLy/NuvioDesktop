...
internal val LocalDesktopShortcutBindings = staticCompositionLocalOf<Map<DesktopShortcutAction, List<DesktopShortcutBinding>>> {
    emptyMap()
}
...
internal fun Map<DesktopShortcutAction, List<DesktopShortcutBinding>>.matchesAny(event: KeyEvent): Boolean =
    event.type == KeyEventType.KeyDown && values.any { bindings -> bindings.any { it.matches(event) } }
